package jakester.jakester.auth.configuration;
...
import jakester.jakester.auth.security.JwtAuthenticationEntryPoint;
import jakester.jakester.auth.security.JwtAuthenticationFilter;
